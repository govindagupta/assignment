...
SECRET_KEY = 'eopfk9^2irz&3v+^k&)j@l2pb8#4a21e*bbo_xxa5gsc0@6c1e'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ['DB_FIRST_NAME'],
        'USER': os.environ['DB_FIRST_USER'],
        'PASSWORD': os.environ['DB_FIRST_PASSWORD'],
        'HOST': os.environ['DB_FIRST_HOST'],
        'PORT': '5432',
    }
}
